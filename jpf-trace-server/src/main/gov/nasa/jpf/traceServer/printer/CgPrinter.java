...
/**
 * Printer for the choice generator
 * {@link gov.nasa.jpf.traceServer.traceStorer.EventTypes.eventGroupType
 * eventGroupType} (choiceGeneratorSet, choiceGeneratorAdvanced,
 * choiceGeneratorProcessed, choiceGeneratorRegistered).
 * 
 * @author Igor Andjelkovic
 * 
 */
public class CgPrinter extends EventPrinter {

  public CgPrinter(Config conf, String tracePrinterPrefix) {
  ...
  public void print(PrintWriter out, Event event) {
    ...
    out.print(TAB);
    out.print(event.getProperty(PropertyCollection.CHOICE_GENERATOR_TYPE));
    out.print(DELIMITER);
    out.println(event.getProperty(PropertyCollection.CHOICE_GENERATOR_CHOICE));

    super.print(out, event);
  }

  public String getName() {
    return eventGroupType.cg.toString();
  }
}
