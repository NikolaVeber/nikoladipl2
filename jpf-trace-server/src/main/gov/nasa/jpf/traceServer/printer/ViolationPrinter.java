...
/**
 * Printer for the property violation
 * {@link gov.nasa.jpf.traceServer.traceStorer.EventTypes.eventGroupType
 * eventGroupType} (propertyViolated).
 * 
 * @author Igor Andjelkovic
 * 
 */
public class ViolationPrinter extends EventPrinter {

  public ViolationPrinter(Config conf, String tracePrinterPrefix) {
  ...
  public String getName() {
    return eventGroupType.violation.toString();
  }
