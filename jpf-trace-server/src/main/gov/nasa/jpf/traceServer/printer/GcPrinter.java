...
/**
 * Printer for the garbage collector
 * {@link gov.nasa.jpf.traceServer.traceStorer.EventTypes.eventGroupType
 * eventGroupType} (gcBegin, gcEnd).
 * 
 * @author Igor Andjelkovic
 * 
 */
public class GcPrinter extends EventPrinter {

  public GcPrinter(Config conf, String tracePrinterPrefix) {
  ...
  public String getName() {
    return eventGroupType.gc.toString();
  }
}
