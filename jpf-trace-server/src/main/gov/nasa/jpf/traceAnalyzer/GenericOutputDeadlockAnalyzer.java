 ...
 * 
 */
public class GenericOutputDeadlockAnalyzer extends TraceAnalyzer {
  ...
  public GenericOutputDeadlockAnalyzer(String query, String dbLocation) {
  ...
  public void printAllColumnOps() {
    ...
    ((EventPrinter)printers[EventTypes.eventGroupType.object.ordinal()])
        .addDesiredProperty(1, (PropertyCollection.THREAD_ID));
    ((EventPrinter)printers[EventTypes.eventGroupType.thread.ordinal()])
        .addDesiredProperty(0, (PropertyCollection.OBJECT_REFERENCE));

    tracePrinter.printTrace(iterator, ONE_PRIORITY);
  }
  ...
  public void printEssentialOps() {
    ...
    tracePrinter.printTrace(iterator, ZERO_PRIORITY);
  ...
  public static void main(String... arg) {
    ...
    GenericOutputDeadlockAnalyzer deadlockAnalyzer = new GenericOutputDeadlockAnalyzer(
        query, dbLocation);
